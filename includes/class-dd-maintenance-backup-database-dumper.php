<?php
/** Serviço de dump incremental do banco. @package DD_Maintenance */
defined( 'ABSPATH' ) || exit;

final class DD_Maintenance_Backup_Database_Dumper {
	private $backup;
	...
	public function run( string $session_id ) {
		...
		return $this->backup->legacy_dump_database_step( $session_id );
	}
}
